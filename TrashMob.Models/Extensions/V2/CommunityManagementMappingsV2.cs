    ...
    public static class CommunityManagementMappingsV2
    {
        ...
        public static CommunityProspectDto ToV2Dto(this CommunityProspect entity)
        {
            ...
            return new CommunityProspectDto
            {
                ...
                PricingFeedback = entity.PricingFeedback,
                KeyObjection = entity.KeyObjection,
                City = entity.City,
        ...
        public static CommunityProspect ToEntity(this CommunityProspectDto dto)
        {
            return new CommunityProspect
            {
                ...
                Name = dto.Name ?? string.Empty,
                Type = dto.Type,
                // TypeRaw is populated by the migration, never by callers — do
                // not accept it on write.
                Department = dto.Department,
                Priority = dto.Priority,
                PricingFeedback = dto.PricingFeedback,
                KeyObjection = dto.KeyObjection,
                City = dto.City,
                Region = dto.Region,
                Country = dto.Country,
