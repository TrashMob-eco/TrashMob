namespace TrashMobMobileApp.Authentication
{
    ...
    public class MSALClientHelper
    {
        ...
        /// <summary>
        /// Gets the MSAL public client application instance for delete user.
        /// </summary>
        /// <value>
        /// The public client application.
        /// </value>
        public IPublicClientApplication PublicClientApplicationDelete { get; private set; }
        ...
        /// <summary>
        /// The PublicClientApplicationDelete builder used internally
        /// </summary>
        private PublicClientApplicationBuilder PublicClientApplicationDeleteBuilder;

        // Token Caching setup - Mac
        // public static readonly string KeyChainServiceName = PublicClientSingleton.Instance.MSALClientHelperInstance.AzureADB2CConfig.KeyChainServiceName;
        ...
        /// <summary>
        /// Initializes the MSAL's PublicClientApplication builder from config for Delete User Flow.
        /// </summary>
        /// <autogeneratedoc />
