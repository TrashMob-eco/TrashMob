...
namespace TrashMob.Shared.Migrations
{
    ...
    [Migration("20260704162827_AddMunicipalPipelineFields")]
    partial class AddMunicipalPipelineFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrashMob.Models.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("LastName", "FirstName")
                        .HasDatabaseName("IX_Contacts_LastName_FirstName");

                    b.ToTable("Contacts");
                });

            modelBuilder.Entity("TrashMob.Models.ContactContactTag", b =>
                {
                    ...
                    b.HasKey("ContactId", "ContactTagId");
                    ...
                    b.ToTable("ContactContactTags");
                });

            modelBuilder.Entity("TrashMob.Models.ContactNote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ContactId")
                        .HasDatabaseName("IX_ContactNotes_ContactId");
            ...
            modelBuilder.Entity("TrashMob.Models.ContactTag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("IX_ContactTags_Name");
            ...
            modelBuilder.Entity("TrashMob.Models.Dependent", b =>
                {
                    ...
                    b.Property<Guid?>("ParentalConsentId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("PrivoSid")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
            ...
            modelBuilder.Entity("TrashMob.Models.DependentInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Email", "InvitationStatusId")
                        .HasDatabaseName("IX_DependentInvitations_Email_Status");

                    b.ToTable("DependentInvitations");
                });
            ...
            modelBuilder.Entity("TrashMob.Models.Donation", b =>
                {
                    ...
                    b.Property<string>("InKindDescription")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<string>("MatchingGiftEmployer")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.HasIndex("ContactId")
                        .HasDatabaseName("IX_Donations_ContactId");
                    ...
                    b.HasIndex("DonationType")
                        .HasDatabaseName("IX_Donations_DonationType");

                    b.HasIndex("LastUpdatedByUserId");

                    b.HasIndex("PledgeId")
                        .HasDatabaseName("IX_Donations_PledgeId");
            ...
            modelBuilder.Entity("TrashMob.Models.EventAttendeeRoute", b =>
                {
                    ...
                    b.Property<int?>("OriginalTotalDistanceMeters")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrashMob.Models.Grant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("AwardDate")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<Guid?>("FunderContactId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("ReportingDeadline")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.HasIndex("FunderContactId")
                        .HasDatabaseName("IX_Grants_FunderContactId");
                    ...
                    b.HasIndex("SubmissionDeadline")
                        .HasDatabaseName("IX_Grants_SubmissionDeadline");

                    b.ToTable("Grants");
                });

            modelBuilder.Entity("TrashMob.Models.GrantTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("GrantId")
                        .HasDatabaseName("IX_GrantTasks_GrantId");

                    b.HasIndex("LastUpdatedByUserId");

                    b.ToTable("GrantTasks");
                });
            ...
            modelBuilder.Entity("TrashMob.Models.ParentalConsent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("PrivoConsentIdentifier")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("PrivoGranterSid")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
                    ...
                    b.HasIndex("PrivoConsentIdentifier")
            ...
            modelBuilder.Entity("TrashMob.Models.Pledge", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ContactId")
                        .HasDatabaseName("IX_Pledges_ContactId");
                    ...
                    b.HasIndex("Status")
                        .HasDatabaseName("IX_Pledges_Status");
            ...
            modelBuilder.Entity("TrashMob.Models.ProspectContact", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("ReferredByContactId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TrashMob.Models.User", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("IdentityVerifiedDate")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("TrashMob.Models.ContactContactTag", b =>
                {
                    b.HasOne("TrashMob.Models.Contact", "Contact")
                        .WithMany("ContactContactTags")
                        .HasForeignKey("ContactId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_ContactContactTags_Contact");

                    b.HasOne("TrashMob.Models.ContactTag", "ContactTag")
                        .WithMany("ContactContactTags")
            ...
            modelBuilder.Entity("TrashMob.Models.Dependent", b =>
                {
                    ...
                    b.HasOne("TrashMob.Models.ParentalConsent", "ParentalConsent")
                        .WithMany()
                        .HasForeignKey("ParentalConsentId")
            ...
            modelBuilder.Entity("TrashMob.Models.DependentInvitation", b =>
                {
                    ...
                    b.HasOne("TrashMob.Models.User", "LastUpdatedByUser")
                        .WithMany("DependentInvitationsUpdated")
                        .HasForeignKey("LastUpdatedByUserId")
                        .IsRequired()
                        .HasConstraintName("FK_DependentInvitations_User_LastUpdatedBy");

                    b.HasOne("TrashMob.Models.User", "ParentUser")
                        .WithMany("DependentInvitationsSent")
                        .HasForeignKey("ParentUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
            ...
            modelBuilder.Entity("TrashMob.Models.Donation", b =>
                {
                    ...
                    b.HasOne("TrashMob.Models.Pledge", "Pledge")
                        .WithMany("Donations")
            ...
            modelBuilder.Entity("TrashMob.Models.Grant", b =>
                {
                    ...
                    b.HasOne("TrashMob.Models.Contact", "FunderContact")
                        .WithMany("GrantsAsFunderContact")
                        .HasForeignKey("FunderContactId")
                        .OnDelete(DeleteBehavior.SetNull)
            ...
            modelBuilder.Entity("TrashMob.Models.GrantTask", b =>
                {
                    ...
                    b.HasOne("TrashMob.Models.Grant", "Grant")
                        .WithMany("GrantTasks")
            ...
            modelBuilder.Entity("TrashMob.Models.ParentalConsent", b =>
                {
                    b.HasOne("TrashMob.Models.User", "CreatedByUser")
                        .WithMany("ParentalConsentsCreated")
                        .HasForeignKey("CreatedByUserId")
                        .IsRequired()
            ...
            modelBuilder.Entity("TrashMob.Models.ProspectContact", b =>
                {
                    ...
                    b.HasOne("TrashMob.Models.ProspectContact", "ReferredByContact")
                        .WithMany()
            ...
            modelBuilder.Entity("TrashMob.Models.Contact", b =>
                {
                    ...
                    b.Navigation("GrantsAsFunderContact");
            ...
            modelBuilder.Entity("TrashMob.Models.Dependent", b =>
                {
                    b.Navigation("DependentInvitations");
            ...
            modelBuilder.Entity("TrashMob.Models.User", b =>
                {
                    ...
                    b.Navigation("DependentInvitationsAccepted");

                    b.Navigation("DependentInvitationsCreated");

                    b.Navigation("DependentInvitationsSent");

                    b.Navigation("DependentInvitationsUpdated");
                    ...
                    b.Navigation("ParentalConsents");

                    b.Navigation("ParentalConsentsAsGranter");

                    b.Navigation("ParentalConsentsCreated");

                    b.Navigation("ParentalConsentsUpdated");
