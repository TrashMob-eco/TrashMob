namespace TrashMob.Shared.Managers.Interfaces
{
    ...
    public interface IEventPartnerLocationServiceManager : IBaseManager<EventPartnerLocationService>
    {
        ...
        Task<IEnumerable<DisplayPartnerLocationServiceEvent>> GetByPartnerLocationAsync(Guid partnerLocationId, CancellationToken cancellationToken = default);

        Task<IEnumerable<DisplayPartnerLocationServiceEvent>> GetByUserAsync(Guid userId, CancellationToken cancellationToken = default);

        Task<PartnerLocation> GetHaulingPartnerLocationForEvent(Guid eventId, CancellationToken cancellationToken = default);
