namespace TrashMob.Shared.Tests
{
    ...
    public class ActiveDirectoryManagerTest
    {
        ...
        public async Task ValidateUserAsync_ValidUser_Succeeds()
        {
            ...
            mockUserManager.Setup(m => m.UserExistsAsync(It.IsAny<string>(), It.IsAny<CancellationToken>()))
                .Returns(Task.FromResult<User>(null));
            mockUserManager.Setup(m => m.GetUserByUserNameAsync(It.IsAny<string>(), It.IsAny<CancellationToken>()))
                .Returns(Task.FromResult<User>(null));
        ...
        public async Task ValidateUserAsync_EmailExists_Fails()
        {
            ...
            mockUserManager.Setup(m => m.GetUserByEmailAsync(It.IsAny<string>(), It.IsAny<CancellationToken>()))
