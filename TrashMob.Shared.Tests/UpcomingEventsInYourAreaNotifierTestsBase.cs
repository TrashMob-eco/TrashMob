namespace TrashMob.Shared.Tests
{
    ...
    public abstract class UpcomingEventsInYourAreaNotifierTestsBase : NotifierTestsBase
    {
        ...
        public async Task GenerateNotificationsAsync_WithNoDataAvailable_Succeeds()
        {
            ...
            // Assert
            UserNotificationManager.Verify(_ => _.AddAsync(It.IsAny<UserNotification>(), It.IsAny<CancellationToken>()),
                Times.Never);
            EmailManager.Verify(
        ...
        public async Task GenerateNotificationsAsync_With1EventForUser_Sends1Email()
        {
            ...
            EmailManager.Verify(
                _ => _.SendTemplatedEmailAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(),
                    It.IsAny<object>(), It.IsAny<List<EmailAddress>>(), It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        public async Task GenerateNotificationsAsync_With2EventForUser_Sends2Emails()
        {
            ...
            EmailManager.Verify(
                _ => _.SendTemplatedEmailAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(),
                    It.IsAny<object>(), It.IsAny<List<EmailAddress>>(), It.IsAny<CancellationToken>()),
                Times.Exactly(2));
        }
        ...
        [Fact]
        public async Task
            GenerateNotificationsAsync_With1EventFor1UsersWhoIsAttendingOtherEventsButNotThisOne_SendsOneEmail()
        {
            // Arrange
            var events = GetEventList1();
            var users = GetUserList1();
        ...
        public async Task GenerateNotificationsAsync_With1EventFor1UsersWhoHasAlreadyReceivedTheEmail_SendsNoEmail()
        {
            ...
            UserNotificationManager
                .Setup(ea => ea.GetCollectionAsync(It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
        ...
        [Fact]
        public async Task
            GenerateNotificationsAsync_With1EventFor1UsersWhereEventIsMoreThanRequiredHoursAway_SendsNoEmail()
        {
            // Arrange
            var events = GetEventList1();
            var users = GetUserList1();
        ...
        [Fact]
        public async Task
            GenerateNotificationsAsync_With1EventFor1UsersWhereEventIsOutsideOfTravelPreference_SendsNoEmail()
        {
            // Arrange
            var events = GetEventList1();
            var users = GetUserList1();
