    ...
    render() {
        return (
            <div>
                ...
                <p>But by forming partnerships, we can share information about what is working, and what is not. Trashmob is attempting to fix the very final stages of the waste management problem... fixing the damage done. Other 
                ...
                <p>We're just starting out, so this page is otherwise empty. But if you've found us, and you want to become a partner, in whatever way that means, please contact us.</p>
            </div>
        );
    }
}
