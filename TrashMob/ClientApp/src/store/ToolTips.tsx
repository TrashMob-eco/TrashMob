...
export const UserProfileSurName = "[Optional] Provide your sur name if you prefer to not use a user name."
export const UserProfileEmail = "Provide your email so you can receive event notifications."
