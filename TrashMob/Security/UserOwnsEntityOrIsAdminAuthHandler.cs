namespace TrashMob.Security
{
    ...
    public class
        UserOwnsEntityOrIsAdminAuthHandler : AuthorizationHandler<UserOwnsEntityOrIsAdminRequirement, BaseModel>
    {
        ...
        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context,
            UserOwnsEntityOrIsAdminRequirement requirement, BaseModel resource)
        {
            try
            {
                ...
                {
                    AuthorizationFailure.Failed(new List<AuthorizationFailureReason>
                        { new(this, "User does not own entity and is not a site admin.") });
                }
            }
            catch (Exception ex)
            {
