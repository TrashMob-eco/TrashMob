...
export const EditEventMediaInstagramUrl = "Enter the Instagram Url of the post you wish to add to the Event.";
export const EditEventMediaYouTubeVideoId = "Enter the YouTube Video Id of the video you wish to add to the Event.";
...
export const CommunityRequestContactName = "A name at the city who might be able to help us get started. (optional)."
export const CommunityRequestEmail = "The email address for your city's public works or waste disposal department. (optional)"
export const CommunityRequestPhone = "The phone number for your city's public works or waste disposal department. (optional)"
export const CommunityRequestWebsite = "The website for your city."
export const CommunityRequestCity = "The City will auto-populate when clicking a location on the map."
export const CommunityRequestCountry = "The Country will auto-populate when clicking a location on the map."
export const CommunityRequestRegion = "The Region will auto-populate when clicking a location on the map. If you want to choose it from the list, pick a Country first."
export const CommunityRequestPostalCode = "The Postal Code will auto-populate when clicking a location on the map if there is a Postal Code for that location."
export const CommunityRequestLatitude = "The Latitude will auto-populate when clicking a location on the map. It must be between -90.0 and 90.0"
export const CommunityRequestLongitude = "The Longitude will auto-populate when clicking a location on the map. It must be between -180.0 and 180.0"
export const CommunityCity = "The City will auto-populate when clicking a location on the map."
export const CommunityCountry = "The Country will auto-populate when clicking a location on the map."
export const CommunityRegion = "The Region will auto-populate when clicking a location on the map. If you want to choose it from the list, pick a Country first."
export const CommunityPostalCode = "The Postal Code will auto-populate when clicking a location on the map if there is a Postal Code for that location."
export const CommunityLatitude = "The Latitude will auto-populate when clicking a location on the map. It must be between -90.0 and 90.0"
export const CommunityLongitude = "The Longitude will auto-populate when clicking a location on the map. It must be between -180.0 and 180.0"
export const CommunityStatus = "Whether or not the community is fully onboarded to TrashMob.eco."
