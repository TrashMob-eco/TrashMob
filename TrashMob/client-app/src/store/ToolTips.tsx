...
export const PartnerRequestEmail = "Enter the primary email for person making the request."
export const PartnerRequestPhone = "Enter the primary phone number for person making the request."
