...
import PartnerDashboard, {
  PartnerDashboardMatchParams,
} from "./components/Partners/PartnerDashboard";
...
import {
  CancelEvent,
  CancelEventMatchParams,
} from "./components/EventManagement/CancelEvent";

import "./custom.css";
import "react-phone-input-2/lib/style.css";
import DeleteMyData from "./components/Pages/DeleteMyData";
import Waivers from "./components/Waivers/Waivers";
import WaiversReturn, {
  WaiversReturnMatchParams,
} from "./components/Waivers/WaiversReturn";
import PartnerRequestDetails, {
  PartnerRequestDetailsMatchParams,
} from "./components/Partners/PartnerRequestDetails";
...
interface AppProps
  extends RouteComponentProps<ManageEventDashboardMatchParams> {}

interface PartnerProps
  extends RouteComponentProps<PartnerDashboardMatchParams> {}
...
interface PartnerRequestDetailsProps
  extends RouteComponentProps<PartnerRequestDetailsMatchParams> {}

interface WaiversReturnProps
  extends RouteComponentProps<WaiversReturnMatchParams> {}
            ...
            <div className="container-fluid px-0">
              <Switch>
                ...
                <Route
                  ...
                  render={(props: PartnerProps) =>
                    renderPartnerDashboard(props)
                  }
                />
                <Route
                  path="/partnerrequestdetails/:partnerRequestId"
                  render={(props: PartnerRequestDetailsProps) =>
                    renderPartnerRequestDetails(props)
                  }
                />
                <Route
                ...
                <Route
                  ...
                  render={(props: WaiversReturnProps) =>
                    renderWaiversReturn(props)
                  }
                />
                <Route
                  path="/deletemydata"
                  render={(props: DeleteMyDataProps) =>
                    renderDeleteMyData(props)
                  }
                />
