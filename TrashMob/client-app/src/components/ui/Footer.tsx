        ...
        <div className="my-5">
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              ...
              <a href={"https://donate.stripe.com/14k9DN2EnfAog9O3cc"}>
                Donate
              </a>
            </div>
          ...
          <div className="row" id="copyright">
            <div className="col-md-8">
              ...
              <p>
                TrashMob is a non-profit, 501(c)(3) organization based in
              ...
              <div className="row" id="iconsOrigWrapper">
                <div className="d-flex justify-content-between">
                  ...
                  <div className="iconWrapper">
                    <a
                      href={
                        "https://www.youtube.com/channel/UC2LgFmXFCA8kdkxd4IJ51BA"
                      }
                      target="_blank"
                      rel="noreferrer noopener"
                    >
