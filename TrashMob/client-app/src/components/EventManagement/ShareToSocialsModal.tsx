...
export const SocialsModal: React.FC<ModalProps> = (props) => {
    ...
    const eventDate = props.eventToShare
        ? new Date(props.eventToShare.eventDate).toLocaleDateString('en-us', {
              year: 'numeric',
              month: '2-digit',
              day: '2-digit',
          })
        : '';
    const eventTime = props.eventToShare
        ? new Date(props.eventToShare.eventDate).toLocaleTimeString('en-us', {
              hour12: true,
              hour: 'numeric',
              minute: '2-digit',
          })
    ...
    const renderCopyToClipboardToolTip = <Tooltip id='tooltip'>{ToolTips.CopyToClipboard}</Tooltip>;
                ...
                <Card.Body className='p-0' style={{ backgroundColor: '#f0f0f1' }}>
                    <div className='ml-2 px-2 py-1'>
                        ...
                        <div className='d-flex align-items-center justify-content-between'>
                            ...
                            <OverlayTrigger
                                placement='top'
                                overlay={renderCopyToClipboardToolTip}
                                trigger={['click']}
                                show={copiedLink}
                            >
                                <Button className='btn mb-2' id='helpBtn' onClick={handleCopyLink}>
                                    <Clipboard />
                                </Button>
                            </OverlayTrigger>
                        </div>
