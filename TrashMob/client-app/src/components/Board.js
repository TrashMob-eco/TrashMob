...
var JakeDiliberto_svg_1 = require("./assets/boardOfDirectors/JakeDiliberto.svg");
...
var RobertRund_jpg_1 = require("./assets/boardOfDirectors/RobertRund.jpg");
var SofiaSamuels_png_1 = require("./assets/boardOfDirectors/SofiaSamuels.png");
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(react_bootstrap_1.Container, { className: 'my-5 pb-5' },
            ...
            React.createElement("div", { className: 'p-4 directorCard' },
                React.createElement(react_bootstrap_1.Row, null,
                    React.createElement(react_bootstrap_1.Col, { md: 5 },
                        React.createElement(react_bootstrap_1.Image, { src: JakeDiliberto_svg_1.default, alt: "Jake Diliberto", className: "h-100 mt-0 object-fit-cover rounded" })),
                    React.createElement(react_bootstrap_1.Col, { md: 7 },
                        React.createElement("div", { className: 'd-flex justify-content-between align-items-center' },
                            React.createElement("h2", { className: 'm-0 fw-500 font-size-xl color-primary ' }, "Jake Diliberto"),
                            React.createElement("a", { href: "https://www.linkedin.com/in/jakediliberto/" },
                                React.createElement(react_bootstrap_1.Image, { src: linkedin_svg_1.default, alt: "linkedIn icon", className: "h-100 mt-0 object-fit-cover" }))),
                        React.createElement("h5", { className: 'my-3 fw-500 color-grey' }, "Member at large"),
                        React.createElement("p", { className: 'font-size-sm color-grey' }, "Jake Diliberto is a senior operations professional having managed a (NYSE) fortune 500 portfolio. He has proven expertise in transformational management with comprehensive experience managing multiple operating units, driving change management, project management, process reengineering, resource optimization, and systems implementations."),
                        React.createElement("p", { className: 'font-size-sm color-grey' }, "Jake also has veteran/military front-line field leadership expertise, having directed and motivated teams in high pressure settings with real-time consequences.")))),
            React.createElement("div", { className: 'p-4 directorCard' },
                React.createElement(react_bootstrap_1.Row, null,
                    React.createElement(react_bootstrap_1.Col, { md: 5 },
