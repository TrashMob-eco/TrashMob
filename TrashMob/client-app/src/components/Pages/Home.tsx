                ...
                <Row className='shadow position-relative'>
                    <Col className='d-flex flex-column px-0 py-4 pl-lg-5' sm={6} style={{ zIndex: 1 }}>
                        <div className='ml-sm-2 ml-lg-5 pl-sm-3 pl-md-5 mt-md-5 mb-md-2'>
                            <img src={Logo} alt='TrashMob.eco logo' className='banner-logo' />
                            <h3 className='ml-md-4 mt-4 mb-4 mb-md-5 font-weight-bold font-size-xl banner-heading pl-3'>
                                Meet up. Clean up. Feel good.
                            </h3>
                            <Link className='btn btn-primary ml-5 py-md-3 banner-button' to='/gettingstarted'>
                                Join us today
                            </Link>
                            <Button
                    ...
                    <img src={Globe2} className='position-absolute p-0 m-0 h-100 banner-globe' alt='Globe' />
                </Row>
            </Container>
                ...
                <Container className='py-5'>
                    <Row className='py-5'>
                        <Col md={6}>
                            ...
                            <Link className='mt-5 btn btn-primary btn-128' to='/aboutus' role='button'>
                                Learn more
                            </Link>
                        </Col>
                        <Col md={6}>
