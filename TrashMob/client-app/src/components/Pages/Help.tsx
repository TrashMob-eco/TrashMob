            ...
            <Row className='p-4'>
                <Col md={6}>
                    ...
                    <p className='para'>
                        ...
                        This will open a new screen that allows you to set your "Home" location. Note that this isn't where you live. It's just a point nearby.
                    </p>
                    <p className='para'>
                        Next, set how far you are willing to travel for an event, and indicate whether or not you prefer miles or kilometers.
                        You will only get notified for events within that travel radius from the location you choose, so choose the location and the distance appropriately
                ...
                <Col md={6}>
                    ...
                    <p className='para'>
                        If you want help from a partner for the event, and there are partners registered in your area, you can select from the list of available partners and the services they provide (Hauling, Disposal, Supplies or Starter Kits). 
                        If there are no partners available in your area, click the Invite a Partner button and invite potential partners in your community to join TrashMob!
                    </p>
                </Col>
            </Row>
        </div>
        ...
        <div className='active-border rounded mt-4 bg-white'>
            ...
            <Row className='p-4'>
                <Col md={6}>
                    ...
                    <p className='para'>
                        This will take you to a form that will allow you to apply to Become a Partner. Fill out the form, specifying a Name (i.e. your company name or city name), whether you are a government or a business, your contact email and website, and a phone number. 
                        Then, using the map, set the location for your main office. You may have other locations (franchises, shops, yards) but those will be added later. Click the submit button.
                    </p>
                    <p className='para'>
                    ...
                    <p className='para'>
                        The Manage Partner Admins page allows you to set who can update the locations, contacts, etc. for the partner. It is recommended to have multiple admins set up for each partner just in case someone leaves your organization or is unavailable when needed. 
                        It's a good idea to keep this list updated as people join/leave your organization to keep your Partnership data secure.
                    </p>
                    <p className='para'>
                    ...
                    <p className='para'>
                        The Manage Partner Social Media Accounts allows you to list the social media accounts that are managed by your organization which you would like us to copy in when we post about events you are involved in to social media. 
                        This allows TrashMob to gain volunteers through your social media reach, and allows you to gain community appreciation through your involvement with TrashMob.
                    </p>
                    <p className='para'>
                        The most important sub-page under the Manage Partner page is the Manage Partner Location Page. Partner Locations are an integral part of TrashMob.eco. 
                        A partner location can be as simple as the location of a dumpster that TrashMob.eco volunteers can use to dispose of litter during an event, or an office to contact to arrange for hauling of picked litter, or a place to pick up supplies or starter kits. 
                        A partner can have many locations, but must always have at least 1.
                    </p>
                </Col>
                <Col md={6}>
                    <p className='para'>
                    ...
                    <p className='para'>
                        Choose a name and set the location via the map. Make this setting as accurate as possible, especially if the location is a drop off point for picked litter. 
                        Public Notes will be visible to the general public when the event lead is looking for partners, and for any event attendees who need information about the location. 
                        This should include hours of operation, or any special instructions to follow when using this location. Private notes are only for communication with TrashMob staff or for internal use for the partner location to communicate back to the headquarters.
                    </p>
                    <p className='para'>
                        Once you have set the location, save the changes. You will now be able to Add Partner Location Contacts. These are the people who will receive emails of get phone calls from Event Leads when events are set up near you. 
                        It is recommended to set up an email distribution group for each location internally instead of listing individuals to prevent messages from getting lost when people leave your organization. Save changes when complete.
                    </p>
                    <p className='para'>
                    ...
                    <p className='para'>
                        You don't have to provide all services. Just set up the ones you have capabilities to handle. If you would like to provide starter kits, the basics are a 5 gallon plastic bucket, a grabber, a reflective safety vest, 30 gallon trash bags, and gloves. 
                        You can either obtain these yourself, or work with TrashMob.eco staff to put the kits together.
                    </p>
                    <p className='para'>
                    ...
                    <p className='para'>
                        ...
                        If, for instance, you are offering starter kits no matter where or when within you community, and the event lead can just show up and get the kits at any time, then set this flag to false. 
                        If, however, you need to make sure crews are available to haul litter before you agree to handle the request for hauling, set this to true to make sure you have advance notice before an event so the bags don't just sit by the roadside indefinitely.
                    </p>
                    <p className='para'>
                    ...
                    <p className='para'>
                        Becoming a partner takes a little bit of work, but helping your community get and stay clean can be extremely rewarding. 
                        It doesn't require a huge outlay of cash up front (unless you want to put together a large collection of starter kits). A few minutes a month can go a long way to generating goodwill within the community, and helping to create a cleaner planet!
                    </p>
                </Col>
            </Row>
        </div>
...
export const Help: React.FC = () => {
    ...
    return (
        <>
            <HeroSection Title='Site Help' Description='Answering your questions!'></HeroSection>
