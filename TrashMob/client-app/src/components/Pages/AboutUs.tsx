                                ...
                                <ol className='list-unstyled mt-5 p-sm-5'>
                                    <li className='mb-4'>
                                        <div className='d-flex align-top'>
                                            ...
                                            <span>
                                                TrashMobs allow you to connect with your local community and foster
                                                relationships built on positive changes.
                                            </span>
                                        </div>
                                    </li>
                                    <li className='mb-4'>
                                        <div className='d-flex align-top'>
                                            ...
                                            <span>
                                                TrashMobs clean up our parks, streams, and neighborhoods which benefits
                                                our Earth and our communities.
                                            </span>
                                        </div>
                                    </li>
                                    <li className='mb-4'>
                                        <div className='d-flex align-top'>
                                            ...
                                            <span>
                                                A TrashMob can tackle highly polluted areas in a shorter time than
                                                individuals which improves morale and satisfaction.
                                            </span>
                                        </div>
                                    </li>
                                    <li className='mb-4'>
                                        <div className='d-flex align-top'>
                                            ...
                                            <span>
                                                TrashMobs can garner attention from neighbors, friends, and local
                                                governments that can spur on more cleanups.
                                            </span>
                                        </div>
                                    </li>
                                    <li className='mb-4'>
                                        <div className='d-flex align-top'>
                                            ...
                                            <span>
                                                TrashMobs can acquire municipal support which can help with the hauling
                                                of gathered trash and providing supplies.
                                            </span>
                                        </div>
                                    </li>
                                </ol>
                        ...
                        <div className='timeline-steps aos-init aos-animate' data-aos='fade-up'>
                            <div className='timeline-step'>
                                ...
                                >
                                    ...
                                    <p className='mb-0 mb-lg-0'>
                                        TrashMob founder, Joe Beernink, first gained inspiration for TrashMob from
                                        Microsoft colleagues. An idea formed for a project that would bring people
                                        together to take small, positive actions that would cascade into meaningful long
                                        term effects.
                                    </p>
                                </div>
                            </div>
                            <div className='timeline-step'>
                                ...
                                >
                                    ...
                                    <p className='mb-0 mb-lg-0'>
                                        Joe, passionate about pollution and climate change, took inspiration from Edgar
                                        McGregor in California who spent over 580 days cleaning up a park in his
                                        community. He began cleaning up his own local parks, and others soon began to
                                        take notice.
                                    </p>
                                </div>
                            </div>
                            <div className='timeline-step'>
                                ...
                                >
                                    ...
                                    <p className='mb-0 mb-lg-0'>
                                        After realizing cleaning up would be too much to do on his own, Joe saw
                                        potential in connecting others. He knew that technology had potential to fix
                                        these human problems, and assembled a team to help bring his vision to life.
                                    </p>
                                </div>
                            </div>
                            <div className='timeline-step'>
                                ...
                                >
                                    ...
                                    <p className='mb-0 mb-lg-0'>
                                        Today, TrashMob has provided communities the opportunity to create and
                                        participate in TrashMobs of their own. The TrashMob team is continuously coming
                                        up with more ways to grow the TrashMob community to achieve the common goal of
