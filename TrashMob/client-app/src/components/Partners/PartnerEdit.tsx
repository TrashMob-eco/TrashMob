...
export const PartnerEdit: React.FC<PartnerEditDataProps> = (props) => {
                                        ...
                                        <Form.Group className='required'>
                                            ...
                                            <div>
                                                <select
                                                    ...
                                                    defaultValue={partnerStatusId}
                                                    onChange={(val) => selectPartnerStatus(val.target.value)}
                                                    required
                                                >
                                        ...
                                        <Form.Group className='required'>
                                            ...
                                            <div>
                                                <select
                                                    data-val='true'
                                                    name='partnerTypeId'
                                                    defaultValue={partnerTypeId}
                                                    onChange={(val) => selectPartnerType(val.target.value)}
                                                    required
                                                >
    ...
    const contents =
        isPartnerDataLoaded && props.partnerId ? (
