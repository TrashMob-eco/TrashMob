...
!(function (e, y) {
    ...
    var r =
        ((i.merge = function (e, t) {
            for (
                var r = window || global, o = 0, a = e.split('.');
                o < a.length;
                o++
            ) {
                var i = a[o];
    ...
    var s,
        l =
            ...
            (u.prototype.setOptions = function (e) {
                ...
                e.source &&
                    t.source !== e.source &&
                    ((t.source = e.source), (r.source = e.source), (o = !0)),
                    e.sourceLayer &&
                        t.sourceLayer !== e.sourceLayer &&
                        ((t.sourceLayer = e.sourceLayer),
                    ...
                    e.filter &&
                        ...
                        (r.filter = e.filter),
                        (o = !0)),
                    'number' == typeof e.minZoom &&
                        t.minZoom !== e.minZoom &&
                        ((t.minZoom = e.minZoom), (r.minZoom = e.minZoom)),
                    'number' == typeof e.maxZoom &&
                        t.maxZoom !== e.maxZoom &&
                        ((t.maxZoom = e.maxZoom), (r.maxZoom = e.maxZoom)),
                    void 0 !== e.visible &&
                        t.visible !== e.visible &&
                        ((t.visible = e.visible), (r.visible = e.visible)),
                    e.markerCallback &&
                        t.markerCallback != e.markerCallback &&
                        ((t.markerCallback = e.markerCallback), (o = !0)),
                    'boolean' == typeof e.updateWhileMoving &&
                        t.updateWhileMoving !== e.updateWhileMoving &&
                        (t.updateWhileMoving = e.updateWhileMoving),
                    o ? this._clearCache(!0) : this._updateMarkers(),
                    s.prototype.setOptions.call(this, r);
            }),
            (u.prototype.update = function () {
                this._clearCache(!0), this._updateMarkers();
            }),
            (u.prototype.onAdd = function (e) {
                var t = this,
                    r = e.events;
                e &&
                    (r.remove('moveend', t._updateMarkers),
            ...
            (u.prototype._getSourceClass = function () {
                ...
                return 'string' == typeof e && null !== this._map
                    ? this._map.sources.getById(e)
                    : e instanceof y.source.Source
                      ? e
                      : null;
            }),
            (u.prototype._clearCache = function (e) {
                var t = this;
                if (((t._markerCache = {}), t._map))
                ...
                (t._markers = []), (t._markerIds = []), e && t._updateMarkers();
            }),
            (u.prototype._getMarker = function (o, a, i) {
                var n = this,
                    s = n._markerCache,
                    e = n._options;
                if (((o = o || a.join(',') + JSON.stringify(i || {})), s[o]))
                    return s[o];
                ...
                return r ? ((s[o] = r), Promise.resolve(r)) : null;
            }),
                                ...
                                return k < _
                                    ? ((p = v = null),
                                      l[k] instanceof y.Shape
                                          ...
                                          : 'Point' ===
                                                (f = l[k]).geometry.type &&
                                            ((m = f.geometry.coordinates),
                                            (d = f.properties) && d.cluster
                                                ? (p =
                                                      'cluster_' +
                                                      f.properties.cluster_id)
                                                : f.id && (p = f.id)),
                                      m ? [4, t._getMarker(p, m, d)] : [3, 3])
                                    : [3, 4];
                            case 2:
                                (v = e.sent())._eventsAttached ||
                                    (t._addEvents(v), (v._eventsAttached = !0)),
                                    v &&
                                        (v.id && c.push(v.id),
                                        (v.id &&
                                            -1 !==
                                                t._markerIds.indexOf(v.id)) ||
                                            (u.push(v), r.markers.add(v))),
                                    (e.label = 3);
                            case 3:
                                return k++, [3, 1];
                            case 4:
                                for (k = o.length - 1; 0 <= k; k--)
                                    (o[k].id && -1 !== c.indexOf(o[k].id)) ||
                                        (r.markers.remove(o[k]),
                                        o.splice(k, 1));
                                return (
                                    (t._markers = o.concat(u)),
                                    (t._markerIds = c),
                                    [3, 6]
                                );
                            case 5:
                                0 < t._markers.length &&
                                    (r.markers.remove(t._markers),
                                    (t._markers = [])),
                                    (e.label = 6);
                            case 6:
                                return [2];
    ...
    var b,
        c = Object.freeze({ __proto__: null, HtmlMarkerLayer: l }),
        p =
            (t(C, (b = y.HtmlMarker)),
            ...
            (C.prototype.getSlicePercentage = function (e) {
                return 0 < this._total
                    ? Math.round((this.getSliceValue(e) / this._total) * 1e4) /
                          100
                    : 0;
            }),
            (C.prototype.getOptions = function () {
                return Object.assign(
                    {},
                    b.prototype.getOptions.call(this),
                    this._options,
                );
            }),
            (C.prototype.setOptions = function (e) {
                ...
                e.radius &&
                    0 < e.radius &&
                    e.radius != t.radius &&
                    ((t.radius = e.radius), (o = !0)),
                    0 <= e.innerRadius &&
                        e.innerRadius != t.innerRadius &&
                        ((t.innerRadius = e.innerRadius), (o = !0)),
                    e.colors &&
                        r(e.colors) !== r(t.colors) &&
                        ((t.colors = e.colors), (o = !0)),
                    e.fillColor &&
                        r(e.fillColor) !== r(t.fillColor) &&
                        ((t.fillColor = e.fillColor), (o = !0)),
                    e.strokeColor &&
                        e.strokeColor !== t.strokeColor &&
                        ((t.strokeColor = e.strokeColor), (o = !0)),
                    0 <= e.strokeWidth &&
                        e.strokeWidth != t.strokeWidth &&
                        ((t.strokeWidth = e.strokeWidth), (o = !0)),
                    void 0 !== e.tooltipCallback &&
                        t.tooltipCallback != e.tooltipCallback &&
                        ((t.tooltipCallback = e.tooltipCallback), (o = !0)),
                    e.values &&
                        r(e.values) !== r(t.values) &&
                        ((t.values = e.values), (o = !0)),
                    void 0 !== e.text &&
                        e.text !== t.text &&
                        (b.prototype.setOptions.call(this, { text: e.text }),
                        (o = !0)),
                    void 0 !== e.textClassName &&
                        e.textClassName !== t.textClassName &&
                        ((t.textClassName = e.textClassName), (o = !0)),
                    o && this._render(),
            ...
            (C.prototype._render = function () {
                ...
                if (r) {
                    ...
                    if (
                        (0 < t.innerRadius &&
                            t.innerRadius <= t.radius &&
                            ((m = 'piechart-innercircle-' + l(1e7 * s())),
                            p.push(
                                '<defs><mask id="' +
                                    m +
                        ...
                        for (
                            var h = t.tooltipCallback,
                                f = (2 * Math.PI) / e._total,
                                v = 0;
                            v < r.length;
                            v++
                        ) {
                    ...
                    k &&
                        ...
                        p.push('</svg>'),
                        (b.prototype.getOptions.call(
                            this,
                        ).htmlContent.innerHTML = p.join(''));
                }
            }),
