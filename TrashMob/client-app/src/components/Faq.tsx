...
export const Faq: React.FC = () => {
    return (
        <div>
            ...
            they are along busy roads or in areas which require special gear or special training. We suggest that if you are unable to sign up for the event you want in advance, and still want to do something, that you go to a local park or a nearby area and do some picking
