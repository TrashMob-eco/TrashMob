        ...
        <div className='active-border rounded mt-4 bg-white'>
            ...
            <Row className='p-4'>
                <Col md={6}>
                    ...
                    <p className='para'>Create an event <a href="https://www.trashmob.eco/manageeventdashboard>">here</a> by naming your event, setting a location, and filling in relevant details like date, time, and a description. Share your created event across your network by viewing the event details and clicking “share”. View your created events in your user dashboard. </p>
                ...
                <Col md={6}>
                    ...
                    <p className='m-0'>When you create a public event, anyone can see it and register for it on the site, and the date/time of the event must be in the future.</p>
                    <p className='m-0'>When you create a private event, only you can see it, and the date may be in the past or in the future. This is sometimes useful when you have done some unplanned picking on your own and want to track your effort
                                       after the fact. Eventually, you will be able to send invitations to specific people for a private event.</p>
                </Col>
            </Row>
        </div>
    )
        ...
        <div className='active-border rounded mt-4 bg-white'>
            ...
            <Row className='p-4'>
                <Col md={6}>
                    ...
                    <p className='para'>We ask for your email address so we can contact you regarding events on this website. We’ll never give your email address to outside agencies (unless required by law) or to other users. See our <a href="https://www.trashmob.eco/privacypolicy>">privacy policy</a> for more.</p>
        ...
        <div className='active-border rounded mt-4 bg-white'>
            ...
            <Row className='p-4'>
                <Col md={6}>
                    ...
                    <p className='para'>Yes! Check out our <a href="https://www.trashmob.eco/donate">Donate</a> page!</p>
                    ...
                    <p className='para'>Yes, you can! Please <a href="https://www.trashmob.eco/contactus">Contact us</a> and let us know what you found. Thank you!</p>
                </Col>
                <Col md={6}>
                    <h5 className='font-weight-500'>Is the TrashMob team looking for support? </h5>
                    <p className='para'>Yes! We are always looking for new team members to help us improve TrashMob.eco and implement new features. If you or someone you know has any skills in design, back or front-end development, program management, or applicable non-technical skills, please Contact us!</p>
...
export const Faq: React.FC = () => {
    ...
    return (
        <>
            <HeroSection Title='FAQ' Description='We’ve got you covered.'></HeroSection>
            ...
            <Container fluid className='bg-white py-5 text-center'>
                ...
                <Link className="btn btn-primary ml-5 py-md-3 banner-button" to="/contactus">Contact Us</Link>
            </Container>
        </>
    );
}