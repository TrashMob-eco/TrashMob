    ...
    return (
        <div>
            ...
            <div className='container my-5 prose space-y-4'>
                ...
                <h2 className='font-medium text-3xl'>Consent</h2>
                ...
                <h2 className='font-medium text-3xl'>Log Files</h2>
                ...
                <h2 className='font-medium text-3xl'>Advertising Partners Privacy Policies</h2>
                ...
                <h2 className='font-medium text-3xl'>Third Party Privacy Policies</h2>
                ...
                <h2 className='font-medium text-3xl'>GDPR Data Protection Rights</h2>
                ...
                <h2 className='font-medium text-3xl'>Children's Information</h2>
