...
interface PartnerServiceEditProps {}

export const PartnerServiceEdit = (props: PartnerServiceEditProps) => {
    ...
    const { data: service } = useQuery({
        queryKey: GetPartnerLocationServiceByLocationIdAndServiceType({ locationId, serviceTypeId }).key,
        queryFn: GetPartnerLocationServiceByLocationIdAndServiceType({ locationId, serviceTypeId }).service,
        select: (res) => res.data,
    });
    ...
    useEffect(() => {
        if (service) {
            form.reset({
                ...
                partnerLocationId: service.partnerLocationId,
                notes: service.notes,
                isAutoApproved: service.isAutoApproved,
