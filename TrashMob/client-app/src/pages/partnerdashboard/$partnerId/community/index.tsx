...
export const PartnerCommunityDashboard = () => {
    ...
    >({
        queryKey: GetCommunityDashboard({ communityId: partnerId }).key,
        queryFn: GetCommunityDashboard({ communityId: partnerId }).service,
        select: (res) => res.data,
        enabled: !!partnerId,
    });
    ...
    return (
        <div className='py-8'>
            <div className='flex justify-between items-center mb-6'>
                ...
                <Button asChild>
                    <Link to={`/partnerdashboard/${partnerId}/community/content`}>
...
export default PartnerCommunityDashboard;
