    ...
    return (
        <div>
            ...
            <section className='bg-background py-12! px-4!'>
                <h2 className='font-semibold text-center text-2xl md:text-[40px] mt-10 mb-2'>The Basics</h2>
                <div className='flex flex-col md:flex-row'>
                    ...
                    <div className='basis-full md:basis-1/4'>
                        <div className='flex flex-col w-full max-w-[300px] mx-auto mb-5 text-center'>
                            <img src={picker} className='w-25! h-25! mx-auto' alt='grabber tool' />
                    ...
                    <div className='basis-full md:basis-1/4'>
                        <div className='flex flex-col w-full max-w-[300px] mx-auto mb-5 text-center'>
                            <img src={attitude} className='w-25! h-25! mx-auto' alt='good attitude' />
            ...
            <section className='bg-card'>
                <div className='container py-24!'>
                    <h2 className='font-semibold mb-6'>TrashMob Tips</h2>
                    <ol className='list-none px-0 space-y-4'>
                        <li>
                            <div className='flex align-top'>
                                <span className='mr-3 font-semibold text-2xl text-primary'>1</span>
                                <span>
                        ...
                        <li>
                            <div className='flex align-top'>
                                <span className='mr-3 font-semibold text-2xl text-primary'>2</span>
                                <span>
                        ...
                        <li>
                            <div className='flex align-top'>
                                <span className='mr-3 font-semibold text-2xl text-primary'>3</span>
                                <span>
                        ...
                        <li>
                            <div className='flex align-top'>
                                <span className='mr-3 font-semibold text-2xl text-primary'>4</span>
                                <span>
                        ...
                        <li>
                            <div className='flex align-top'>
                                <span className='mr-3 font-semibold text-2xl text-primary'>5</span>
