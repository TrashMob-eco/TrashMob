                ...
                <>
                    <Card>
                        ...
                        <CardContent className='grid gap-6'>
                            ...
                            {!showAllAttendees && numAttendees > 10 ? <Button variant="link" onClick={() => setShowAllAttendees(true)}>Show all {numAttendees} attendees</Button> : null}
                            {showAllAttendees && numAttendees > 10 ? <Button variant="link" onClick={() => setShowAllAttendees(false)}>Show less</Button> : null}
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader>
