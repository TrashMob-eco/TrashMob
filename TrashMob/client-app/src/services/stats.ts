...
export const GetStatsForUser = (params: GetStatsForUser_Params) => ({ key: ['/stats/', params], service: async () => ApiService('protected').fetchData<GetStats_Response>({ url: `/stats/${params.userId}`, method: 'get' }) });
