...
var workspaces_log_name = '/subscriptions/${subscriptionId}/resourceGroups/${rgName}/providers/microsoft.operationalinsights/workspaces/log-tm-${environment}-${region}'

resource components_as_name_resource 'microsoft.insights/components@2020-02-02' = {
  ...
  properties: {
    ...
    Flow_Type: 'Bluefield'
    Request_Source: 'rest'
    WorkspaceResourceId: workspaces_log_name
