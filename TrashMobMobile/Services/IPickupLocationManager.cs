namespace TrashMobMobile.Data
{
    ...
    {
        Task<IEnumerable<PickupLocationImage>> GetPickupLocationsAsync(Guid eventId, ImageSizeEnum imageSize,
            CancellationToken cancellationToken = default);

        Task<PickupLocationImage> GetPickupLocationImageAsync(Guid pickupLocatioImageId, ImageSizeEnum imageSize,
            CancellationToken cancellationToken = default);
